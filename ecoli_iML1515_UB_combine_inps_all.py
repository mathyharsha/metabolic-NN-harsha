...
DATAPATH = 'external/amn_release/Dataset_model/iML1515_UB.npz' 
...
if __name__ == "__main__":
	...
	break if device.type == 'cpu' and (e>4) else continue
        ...
        checkpoint = {
                        ...
                        'config': {
                            'd_model': model_configs['d_model'][e],
                            'n_heads': model_configs['n_heads'][e],
                            'n_layers': model_configs['n_layers'][e],
                            'd_ff': model_configs['d_ff'][e],
                            'dropout': dropout,
